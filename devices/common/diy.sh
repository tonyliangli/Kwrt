...
coremark wget-ssl curl htop nano zram-swap kmod-lib-zstd kmod-tcp-bbr bash openssh-sftp-server block-mount resolveip kmod-ip6-tunnel ds-lite swconfig /" include/target.mk
...
(
svn export --force -r 5682 https://github.com/coolsnowwolf/lede/trunk/tools/upx tools/upx
svn export --force -r 5682 https://github.com/coolsnowwolf/lede/trunk/tools/ucl tools/ucl
