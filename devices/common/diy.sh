...
rm -f package/feeds/kiddin9/autocore/files/generic/21_ethinfo.js; svn export https://github.com/immortalwrt/immortalwrt/branches/master/package/emortal/autocore/files/generic/29_ethinfo.js package/feeds/kiddin9/autocore/files/generic/21_ethinfo.js
