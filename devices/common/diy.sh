...
# commitid="$(curl -sfL https://github.com/openwrt/openwrt/commits/v21.02.2/include | grep -o 'href=".*>kernel: bump 5.4' | head -1 | cut -d / -f 5 | cut -d '"' -f 1)"
...
svn co -r 4109 https://github.com/coolsnowwolf/lede/trunk/target/linux/generic/hack-5.4 target/linux/generic/hack-5.4
